...
timerange = pd.interval_range(start=0, end=50, freq=0.06)
...
def int_per_timebin(df):
    ...
    features = np.zeros((500, 832)) #seq_size x mass
    for t in range(500):
...
if __name__ == '__main__':
    ...
    np.save('cache/train_bin006_s.npy', cache_metadata)
    ...
    np.save('cache/val_bin006_s.npy', cache_metadata)
    ...
    np.save('cache/test_bin006_s.npy', cache_metadata)
