...
class ResidualLSTM(nn.Module):
    ...
    def __init__(self, d_model):
        ...
        # self.LSTM = TransformerWrapper(d_model, nhead=8, num_layers=1)
...
class NModel(nn.Module):
    def __init__(self, cfg, in_feat):
        ...
        self.cfg = cfg
        # feat_num = 896
        # self.encoder0 =  SeqEncoder2(in_feat, feat_num//2)
        ...
        self.encoder = SAKTModel(in_feat, embed_dim=1280, pos_encode='LSTM',
                    nlayers=2, rnnlayers=3, dropout=0.2,nheads=16) 
        ...
        # self.rnn2 = nn.RNN(num_features, num_features // 2, batch_first=True, num_layers=1, bidirectional=True)
